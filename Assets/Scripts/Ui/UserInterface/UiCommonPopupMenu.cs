...
//https://gamedev.stackexchange.com/questions/142293/how-to-make-a-simple-dialog-system-with-yes-no-options-and-pages/142295
namespace Bronz.Ui
{
    ...
    public class UiCommonPopupMenu : Singleton<UiCommonPopupMenu>
    {
        ...
        public void ShowDialogPanel(CommonPopupScreenPosition commonPopupScreenPosition)
        {
            ...
            canvasGroup.DOFade(1f, fadeAnimDuration);
        }
        ...
        private void HideDialogPanel()
        {
            ...
            canvasGroup.DOFade(0f, fadeAnimDuration).OnComplete(() => canvasGroup.blocksRaycasts = false);
        }
    }
}
