...
{
    public static ItemBank m_instance = null;
    public List<ItemDb> items = new List<ItemDb>();
    private readonly string fileName = "Items";
    ...
    public ItemDb FetchItemDbByID(int id)
    {
    ...
    private void ConstructItemDatabase()
    {
        ...
        TextAsset itemCSV = (TextAsset)Resources.Load("CSVs/" + fileName, typeof(TextAsset));// as TextAsset;
        //print(itemCSV.text);
